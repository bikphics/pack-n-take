...
const ProductDetails = (props) => {
  ...
  const [resturantsData, setResturantsData] = useState(null);
  ...
  useEffect(() => {
    tokenData?.hasOwnProperty('access_token') &&
      getResturantDetails(tokenData.access_token);
  }, [tokenData]);

  const getResturantDetails = (token) => {
    console.log('token Data', token);
    axios
      .get(`https://www.packntake.com/api/packages/${itemId}`, {
        params: {
          token: token,
        },
      })
  ...
  const renderForeground = (
    ...
    return (
      console.log('Resturant Data========]]]]]', resturantsData),
      (
        <ImageBackground
          source={{uri: resturantImage}}
              ...
              <View style={{flex: 1, flexDirection: 'row'}}>
                ...
                <View style={{flex: 2, justifyContent: 'center'}}>
                  <Animated.View
                    ...
                    <Text style={{color: '#ddd'}}>{quantityLeft}+ Left</Text>
                  </Animated.View>
                  <Animated.View
                    style={{
                      backgroundColor: '#394047',
  ...
  const renderHeader = (resturantName, logo, headerBackgroundImage) => {
      ...
      <Animated.View>
        ...
        <Animated.View
          ...
          <Animated.View style={{opacity}}>
            <Text style={styles.headerTitle}>{resturantName}</Text>
          </Animated.View>
          <View>
            <Image
              source={{uri: logo}}
      ...
      <>
        ...
        <StickyParallaxHeader
          foreground={renderForeground(
            resturantsData.RetaurantName,
            resturantsData.PackageImage,
            resturantsData.RetaurantDistanceText,
            resturantsData.PackageQuantityText,
            resturantsData.PackageFPrice,
            resturantsData.PackageSPrice,
          )}
          transparentHeader={true}
          header={renderHeader(
            resturantsData.RetaurantName,
            resturantsData.RetaurantLogo,
            resturantsData.PackageImage,
          )}
          parallaxHeight={350}
          headerHeight={70}
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View
              ...
              <View
                ...
                {resturantsData.InsideThePackge.map((item, index) => (
                  <View
                    key={index}
                    style={{
                      padding: 5,
