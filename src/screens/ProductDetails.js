  ...
  return (
    <>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          style={{backgroundColor: '#ddd', marginTop: 25, paddingVertical: 5}}>
          <Text style={{fontSize: 16, fontWeight: '600', paddingLeft: 15}}>
            HOW TO GET THERE
          </Text>
        </View>
        <View
          style={{width: '100%', height: 250, backgroundColor: '#ccc'}}></View>
        ...
        <View style={{marginTop: 25, backgroundColor: '#ddd'}}>
          ...
          <View style={{flex: 1, flexDirection: 'row', paddingVertical: 10}}>
            <View style={{flex: 2}}>
              <Text
                style={{fontWeight: '600', fontSize: 30, textAlign: 'right'}}>
                4.0/5
              </Text>
            </View>
            <View
