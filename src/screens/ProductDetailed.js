...
const ProductDetailed = (props) => {
  ...
  useEffect(() => {
    console.log('Resturant slug', props.route.params);
    getUserData();
  ...
  return (
    console.log('resturantsDatar', resturantsData),
    (
      <>
        <Modal
          animationType={'slide'}
                    ...
                    <View style={{flex: 1, flexDirection: 'row'}}>
                      <View
                        ...
                        <Text
                          ...
                          A steakhouse, steak house, or chophouse is a
                          restaurant that specializes in steaks and chops.
                          Modern steakhouses may also carry other cuts of meat
                          including poultry, roast prime rib, and veal, as well
