...
import {BAG, EDIT, SHOP, MAP, PEN, HOTEL, INSIDE_PACKAGE} from '../assets';
import {Header} from '../components';
import {COLORS, PT_COLORS} from '../config';

const PreveiousOrderDetails = (props) => {
  return (
    <>
      <Header
        title="Order Status"
      ...
      <View style={{backgroundColor: COLORS.APP_BODY, flex: 1}}>
        <ScrollView>
          ...
          {/* Store Location Card */}
          <Card style={styles.card}>
            <Card.Title title="More Information" style={styles.cardTitle} />
            <Card.Content>
              <Subheading style={{paddingHorizontal: 15}}>
                The restaurant will prepare your package within 30 minutes, we
                will notify you when the food is ready to collect. The
                restaurant will make sure that your food will be well packed.
              </Subheading>
            </Card.Content>
          </Card>
          {/* Store Location Card */}
          ...
          <View style={{paddingVertical: 20}}>
            <Button onPress={() => {}} color={COLORS.GOOGLE}>
              Cancel
            </Button>
            <Subheading style={{textAlign: 'center'}}>
              you can cancel your order, while it's in pending status
            </Subheading>
          </View>
        </ScrollView>
      </View>
...
export default PreveiousOrderDetails;
